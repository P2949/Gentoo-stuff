...
class PackageEnvPolicyTest(unittest.TestCase):
    def test_repository_policy_passes_full_validation(self) -> None:
        ...
        self.assertEqual(result.policy_file_count, 15)
        self.assertEqual(result.assignment_line_count, 160)
        self.assertEqual(result.atom_count, 156)
        self.assertEqual(result.pair_count, 172)
