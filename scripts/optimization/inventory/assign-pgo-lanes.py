...
def main():
 ...
 for x in s['records']:
  ...
  elif any(z in ev for z in ('cmake','meson','autotools','llvm.org','llvm-r1','llvm-r2')): lane='pgo-clang-ir';reason='native-compiled-eclass'
  elif any('python' in z or 'java' in z for z in ev): lane='unsupported-by-upstream-toolchain';reason='managed-language-or-runtime-eclass'
