...
snapshot_frozen_inventory() {
    ...
    if [[ -z ${TEST_ROOT} ]]; then
        ...
        [[ ${verifier_sha256} == 583afd47d095ac7222e1c402bed1690f616d78c8dc4109bda116eb8c0e727741 || \
            ${verifier_sha256} == cdbbfd9a764097b975d2585f307eb576793fb4e07b91963f779769e3bf93b2bc ]] || \
...
' >/dev/null 2>&1; then
    ...
    while IFS= read -r -d '' file; do
        ...
        while IFS= read -r line || [[ -n ${line} ]]; do
            ...
            case ${variable} in
                GENTOO_OPT_MODE|GENTOO_OPT_PUBLIC_ABI|GENTOO_OPT_BOLT_STAGE|GENTOO_OPT_BOLT_GCC_READY|\
