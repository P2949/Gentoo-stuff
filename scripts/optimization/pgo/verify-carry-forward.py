...
def main():
    ...
    required={'record_type','schema_version','source_generation','target_generation','source_record_sha256','target_record_sha256','source_cpv','target_cpv','repository','ebuild_sha256','package_env','package_env_content','build_controls','compiler','abi','target_triple','optimization_flags','workload_revision','training_receipt','merge_evidence','profile_sha256','decision','reason','source_identity_sha256','target_identity_sha256','sha256'}
