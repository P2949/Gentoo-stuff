...
- **Last plan review:** 2026-09-13. Historical post-jsonschema checkpoint evidence is authoritative for prerequisite completion, while the later preliminary Phase-3 wave is explicitly non-authorizing and interrupted. The pinned ShellCheck authority is verified; exact local evidence controls continuation and remote CI is corroborating evidence. Current source requires a new exact candidate; no frozen authorization candidate or detached index exists; Phase 2 remains unauthorized. The complete plan must be reread after each live checkpoint or package operation.
